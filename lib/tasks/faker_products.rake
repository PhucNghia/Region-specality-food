namespace :db do
  task faker_products: :environment do
    ...
    Product.create!(title: "Thịt trâu sấy", name: "Thịt trâu sấy", image: "product/thit_trau_say.jpg", price: 100000,
      discount: 10, status: "Còn hàng", quantities: 1000, region_id: 1, category_id: 1, provider_id: 1)
    ...
    Product.create!(title: "Cu đơ Hà Tĩnh", name: "Cu đơ Hà Tĩnh", image: "product/cu_do.jpg", price: 650000,
      discount: 10, status: "Còn hàng", quantities: 1000, region_id: 2, category_id: 1, provider_id: 1)
    ...
    Product.create!(title: "Muối tôm Tây Ninh", name: "Muối tôm Tây Ninh", image: "product/muoi_tom.jpg", price: 55000,
      discount: 10, status: "Còn hàng", quantities: 1000, region_id: 3, category_id: 1, provider_id: 1)
    Product.create!(title: "Thèo lèo Ninh Thuận", name: "Thèo lèo Ninh Thuận", image: "product/theo_leo.jpg", price: 20000,
      discount: 10, status: "Còn hàng", quantities: 1000, region_id: 3, category_id: 1, provider_id: 1)
